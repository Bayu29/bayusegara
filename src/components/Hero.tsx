...
import { Github, Linkedin, Mail, Download, ArrowDown, Sparkles, MessageCircle } from "lucide-react";
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-8 lg:space-y-10">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-tight">
                ...
                <span className="block bg-gradient-to-r from-primary via-primary to-primary/70 bg-clip-text text-transparent pb-2">
                  Bayu segara
                </span>
              </h1>
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Specializing in full-stack development and scalable solutions 
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center lg:text-left">
                <div className="text-2xl md:text-3xl mb-1">20+</div>
